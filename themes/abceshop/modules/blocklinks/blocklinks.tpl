<!-- MODULE Block links -->
    <div id="block-links" class="block">
        <h4>Odkazy</h4>
        <ul class="icon-list">
            <li><img class="icon" src="{$img_dir}icon-kontakt.jpg" width="25" height="25" alt="{l s='Icon' mod='blocklinks'}" /><a href="#" title="{l s='Contacts' mod='blocklinks'}">{l s='Contacts' mod='blocklinks'}</a></li>
            ...
            <li><img class="icon" src="{$img_dir}icon-platby.jpg" width="25" height="25" alt="{l s='Icon' mod='blocklinks'}" /><a href="{$base_dir}cms.php?id_cms=8" title="{l s='Payments' mod='blocklinks'}">{l s='Payments' mod='blocklinks'}</a></li>
