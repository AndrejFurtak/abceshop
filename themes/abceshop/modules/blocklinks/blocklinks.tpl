...
*}
            ...
            <li><img class="icon" src="{$img_dir}icon-obchodne-podmienky.jpg" width="25" height="25" alt="{l s='Icon' mod='blocklinks'}" /><a href="{$link->getCMSLink(3, 'obchodne-podmienky')}" title="{l s='Trading terms' mod='blocklinks'}">{l s='Trading terms' mod='blocklinks'}</a></li>
            <li><img class="icon" src="{$img_dir}icon-o-nas.jpg" width="25" height="25" alt="{l s='Icon' mod='blocklinks'}" /><a href="{$link->getCMSLink(4, 'o-nas')}" title="{l s='About us' mod='blocklinks'}">{l s='About us' mod='blocklinks'}</a></li>
            <li class="last"><img class="icon" src="{$img_dir}icon-akciovy-letak.png" width="25" height="25" alt="{l s='Icon' mod='blocklinks'}" /><a href="{$link->getCMSLink(11, 'akciovy-letak')}" title="Akciový leták">Akciový leták</a></li> <!-- // TODO: L10N -->
        </ul>
    </div>
<!-- /MODULE Block links -->
